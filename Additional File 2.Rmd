...
## Changes in microbial biomass during the experiment
...
### Species-wise ranges (×10^9^ cells)
...
### Between-species tests (overall and by time)
...
### Within-group change across T0–T1–T2 for each Species × Treatment
...
### Between-species differences (overall and by time)
